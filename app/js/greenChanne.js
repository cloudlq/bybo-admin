define(['moment', 'text!../tpl/party_opt.html', 'daterangepicker', 'bootstrap_table_export', 'fun', 'ajaxfileupload', 'viewer'], function(moment, _opt) {

	var controller = function() {

		var MODEL = "GreenChanne";
		var TITLE = "绿色通道";
		/*全局数据*/
		var DATA = {
			page: 1,
			...
			$('#table').bootstrapTable({
				...
				columns: [{
					...
					formatter: function(value, row) {
						var html = '';
						html += '<span class="opt_btn invest_find" data-href="' + value + '">查看</span>';
						return html;
					}
				}],
		...
		EVENT.INIT = function() {
			...
			/*点击图片预览*/
			$("body").on("click", ".invest_find", function() {
				var pics = $(this).attr("data-href");
				pics = pics.split(",");
				var html = "";
				$.each(pics,function(i,pic){
					html += '<li><img data-original="' + pic + '" src="" alt="图片"></li>';
				});
				$("#viewer").html(html);
				if($("#viewer li").length >= 1) {
					...
					$.scojs_message("暂无图片", $.scojs_message.TYPE_ERROR);
				}

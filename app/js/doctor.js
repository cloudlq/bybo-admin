define(['moment', 'text!../tpl/doctor_view.html', 'text!../tpl/doctor_opt.html', 'daterangepicker', 'bootstrap_table_export', 'fun', 'ajaxfileupload'], function(moment, view, _opt) {
	...
	var controller = function(type) {
		...
		IMPL.DEL = function(id, callback) {
			$.ajax({
				url: 'admin/deleteDoctorById?id=' + id,
				type: "GET",
				contentType: "application/json",
				dataType: "json",
				success: callback
		...
		FUN.INIT_TABLE = function() {
			$('#table').bootstrapTable({
				url: "admin/getDoctorsForPage", //请求后台的URL（*）
				method: 'post', //请求方式（*）
